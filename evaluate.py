...
dir_data   = '/scratch/06898/bchang/finney'  #location of the data
...
for ii in range( 0, np.size(samples) ):
    ...
    del e_test, MIS_z_test, tof_L_test, tof_R_test
    ...
    vel_t_pred_full.tofile(f'/scratch/06898/bchang/current3_{samples[ii]}_prediction.raw')
    vel_t_true_full.tofile(f'/scratch/06898/bchang/current3_{samples[ii]}_true.raw')
    ...
    #fig.savefig('savedModels/%s/prediction.png' % (model_name), dpi=600, transparent=True)
